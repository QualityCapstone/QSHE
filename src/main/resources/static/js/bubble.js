import css from '../css/resources/bubble.css';
...
var Bubbles = function () {
    ...
    Bubbles.prototype.addBgBubble = function addBgBubble() {
        this.aBgBubbles.push(new Bubble('rgba(149,56,141,0.1)', 3.5)); // Color for the bubbles in the back
    };
...
var Bubble = function () {
    function Bubble() {
        var _c = arguments.length <= 0 || arguments[0] === undefined ? 'rgba(254,8,97,0.3)' : arguments[0]; // Color for the bubbles on the front
